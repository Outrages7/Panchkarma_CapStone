    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-amber-50 py-12 px-4">
        <div className="max-w-md w-full bg-white p-8 rounded-2xl shadow-xl text-center">
          ...
          <h2 className="text-2xl font-bold text-stone-900 mb-2">Password Reset Successful!</h2>
        ...
        <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
          ...
          <div className="space-y-4">
            ...
            <div className="bg-amber-50 border border-amber-200 rounded-lg p-3">
              <p className="text-sm text-amber-800 font-medium mb-2">Password Requirements:</p>
